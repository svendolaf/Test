...
; 
; To install:
; The 381 bytes file mbrmenu1 should be written to the first 381 bytes of a
...
; SHA1 of program: c336b533afa7aa6ab47d5b165fc14c2553d35ed7
...
;
; This version was made to avoid repeated read of the MBR, and to reduce
; program size, and thereby making room for addition of program features.
;
